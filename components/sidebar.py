...
def render_sidebar(market_status, dot_class, ICON_TIME, ICON_LAYERS, ICON_CANDLE, ICON_GEAR):
    with st.sidebar:
        ...
        ">
            ...
            <div>
                <div class="qt-title" style="font-size:.84rem;">Controls</div>
                <div class="qt-subtitle">Workspace</div>
            </div>
        </div>
        """,
        ...
        st.markdown(
            ...
            <div class="qt-side-head">{ICON_TIME}<span>Time Frame</span></div>""",
            unsafe_allow_html=True,
        )
        ...
        st.markdown(
            f"""<div class="qt-side-section">
            <div class="qt-side-head">{ICON_LAYERS}<span>Indicators</span></div>""",
            unsafe_allow_html=True,
        )
        ...
        st.markdown(
            f"""<div class="qt-side-section">
            <div class="qt-side-head">{ICON_CANDLE}<span>Sub Panels</span></div>""",
            unsafe_allow_html=True,
        )
        ...
        st.markdown(
            f"""<div class="qt-side-section">
            <div class="qt-side-head">{ICON_GEAR}<span>Actions</span></div>""",
            unsafe_allow_html=True,
        )
